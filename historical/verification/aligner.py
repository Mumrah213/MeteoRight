...
def align_forecasts_with_observations(
    ...
    # left_on/right_on creates both columns — keep both as required
    # forecast_target_time is already present from f_df
    # observation_time is already present from obs_df (will be NaN for unmatched)

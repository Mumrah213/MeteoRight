"""Thin wrappers for the local Open-Meteo API.
...
def _build_url(endpoint: str, params: dict) -> str:
    """Build a full API URL from endpoint and params."""
...
def fetch_forecast(
    ...
    """Fetch a weather forecast from the local API.
...
def fetch_history(
    ...
    """Fetch historical weather data from the local API.
...
def fetch_climate_normals(
    ...
    """Fetch approximate climate normals from the local API.
